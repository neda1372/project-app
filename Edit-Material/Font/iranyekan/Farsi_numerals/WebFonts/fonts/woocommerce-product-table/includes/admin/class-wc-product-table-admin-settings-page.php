    ...
    public function add_settings( $settings, $current_section ) {
        ...
        $plugin_settings = array_merge( $plugin_settings, array(
            array(
                ...
                'desc'  => '<p>' . sprintf ( __( 'You can create product tables using the [product_table] shortcode (either listing all your products or %1$s), or you can automatically replace the standard layouts in your theme.', 'woocommerce-product-table' ), $this->barn2_link( 'kb/wpt-include-exclude', __( 'specific products only', 'woocommerce-product-table' ), false ) ) . '<i>' . $this->barn2_link( 'kb/wpt-shop-category-search-template', __( 'Read more', 'woocommerce-product-table' ), false ) . '</i></p>'
            ),
            array(
